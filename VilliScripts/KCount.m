...
%     repeat the clustering 3 times to avoid local minima
    ...
    outFileName = [myOutput, '\', name, '_K1', ext];
    imwrite(double((villi_epi_1)),outFileName,'tiff');
    outFileName = [myOutput, '\', name, '_K2', ext];
    imwrite(double((villi_epi_2)),outFileName,'tiff');
    outFileName = [myOutput, '\', name, '_K3', ext];
    imwrite(double((villi_epi_3)),outFileName,'tiff');
    outFileName = [myOutput, '\', name, '_K4', ext];
...
outFileNameCSV = [myOutput, '\', 'Areas_K.csv'];
